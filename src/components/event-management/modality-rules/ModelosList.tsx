                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Tem certeza que deseja excluir o modelo "{modelo.descricao || modelo.codigo_modelo}"? 
                            Esta ação não pode ser desfeita e todos os campos configurados também serão removidos.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
