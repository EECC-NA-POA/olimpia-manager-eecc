...
import { Users, ListChecks, BarChart, Bell, UserCheck, Globe, ClipboardCheck, UserPlus, MessageCircle } from "lucide-react";
  ...
  const renderTabContent = (tabName: string) => {
    switch (tabName) {
      ...
      case "enrollments":
        ...
        return <EnrollmentsTab enrollments={confirmedEnrollments} eventId={currentEventId} />;
  ...
  return (
    <div className="w-full py-2 sm:py-6 space-y-2 sm:space-y-6 px-2 sm:px-4 overflow-x-hidden">
      ...
      <Tabs defaultValue="statistics" className="w-full max-w-full" onValueChange={setActiveTab} value={activeTab}>
        ...
        <TabsContent value="bulk-enroll" className="mt-2 sm:mt-6">
          {renderTabContent("bulk-enroll")}
        </TabsContent>

        <TabsContent value="whatsapp-groups" className="mt-2 sm:mt-6">
