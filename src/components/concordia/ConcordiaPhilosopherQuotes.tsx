...
export const ConcordiaPhilosopherQuotes = () => {
  return (
    <div className="mt-8 space-y-6">
      <Card className="bg-white/95 backdrop-blur-sm border-[#7CB342]/20">
        <CardContent className="p-6 space-y-6">
          <div className="space-y-6">
            <div className="quote-item">
              <h4 className="font-semibold text-[#7CB342]">Platão (428–348 a.C.)</h4>
            ...
            <div className="quote-item">
              <h4 className="font-semibold text-[#7E57C2]">Aristóteles (384–322 a.C.)</h4>
              <p className="text-gray-800 mt-2 italic">
            ...
            <div className="quote-item">
              <h4 className="font-semibold text-[#7CB342]">Epicteto (50–135 d.C.)</h4>
              <p className="text-gray-800 mt-2 italic">
            ...
            <div className="quote-item">
              <h4 className="font-semibold text-[#7E57C2]">Sêneca (4 a.C.–65 d.C.)</h4>
              <p className="text-gray-800 mt-2 italic">
            ...
            <div className="quote-item">
              <h4 className="font-semibold text-[#7CB342]">Diógenes de Sinope (412–323 a.C.)</h4>
              <p className="text-gray-800 mt-2 italic">
            ...
            <div className="quote-item">
              <h4 className="font-semibold text-[#7E57C2]">Cícero (106–43 a.C.)</h4>
              <p className="text-gray-800 mt-2 italic">
            ...
            <div className="quote-item">
              <h4 className="font-semibold text-[#7CB342]">Píndaro (518–438 a.C.)</h4>
              <p className="text-gray-800 mt-2 italic">
