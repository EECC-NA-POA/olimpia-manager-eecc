-- CRITICAL FIX: Update RPC to return recurrence fields
-- Previous version was missing recorrente, dias_semana, etc.

DROP FUNCTION IF EXISTS public.get_schedule(uuid, uuid);
